		...
		**/
		if($register_type == "email")
		{
			...
			if($result)
			{
				...
				$sql = "UPDATE " . $GLOBALS['ecs']->table('users') . " SET parent_id = '" . $rec_user . "' WHERE email = '" . $email ."'";
		...
		else if($register_type == "mobile")
		{
			...
			if($result)
			{
				...
				$sql = "UPDATE " . $GLOBALS['ecs']->table('users') . " SET parent_id = '" . $rec_user . "' WHERE mobile_phone = '" . $mobile_phone ."'";

...
/* 当前页面标题及可用链接名称 */
$_LANG['group_buy_list'] = '拼团活动列表';
$_LANG['add_group_buy'] = '添加拼团活动';
$_LANG['edit_group_buy'] = '编辑拼团活动';
...
$_LANG['error_group_buy'] = '您要操作的拼团活动不存在';
...
$_LANG['no_select_group_buy'] = '您现在没有拼团活动记录！';

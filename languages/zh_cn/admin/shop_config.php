...
//weijie sta
$_LANG['cfg_name']['need_mobile'] = '绑定手机才能下单';
$_LANG['cfg_range']['need_mobile']['1'] = '开启';
$_LANG['cfg_range']['need_mobile']['0'] = '关闭';
$_LANG['cfg_name']['need_email'] = '绑定邮箱才能下单';
$_LANG['cfg_range']['need_email']['1'] = '开启';
$_LANG['cfg_range']['need_email']['0'] = '关闭';
//weijie end
...
$_LANG['cfg_name']['group_goods_number'] = '拼团商品的数量';
...
$_LANG['cfg_name']['commission1'] = '获取一级会员进货（%）';
$_LANG['cfg_name']['commission2'] = '获取二级会员进货（%）';
$_LANG['cfg_name']['txshouxu'] = '提现手续费（%）';
$_LANG['cfg_name']['meiri'] = '每日分红';
$_LANG['cfg_name']['yjnum'] = '推荐一级会员（人）';
$_LANG['cfg_name']['yjlj'] = '一级会员累计进货';
$_LANG['cfg_name']['100lj'] = '会员100天累计';
$_LANG['cfg_name']['100fh'] = '100天增加分红权（个）';
$_LANG['cfg_name']['chongzhi'] = '会员充值';
$_LANG['cfg_name']['chongzhifh'] = '充值分红权（个）';
$_LANG['cfg_name']['jhleiji'] = '进货累计';
$_LANG['cfg_name']['fhsx'] = '分红权上限';
$_LANG['cfg_name']['txbz'] = '提现最低（元）';
$_LANG['cfg_name']['bili'] = '分红比例(%)';

$_LANG['cfg_name']['wbzc'] = 'VIP设置';
$_LANG['cfg_name']['gftxsx'] = '股份提现手续(￥)';
$_LANG['cfg_name']['moshi'] = 'VIP会员一年(￥)';
$_LANG['cfg_name']['money1'] = 'VIP会员试用(￥)';
$_LANG['cfg_name']['moregu'] = 'VIP会员半年(￥)';

...
SWFUpload.onload = function () {
	var settings = {
		...
		post_params: {"goods_id" : "<?php echo $_REQUEST['goods_id'];?>"},
...
<body>
<div  style="padding:0 auto;margin:10px auto 0 auto;width:98%;height:35px;line-height:35px;border:1px solid #bbdde5;background:#f4fafb;">
<span style="float:left;padding-left:10px;font-size:17px;font-weight:bold;"><a href="index.php?act=main">ECSHOP 管理中心</a> </span>
<span  style="float:left;font-size:15px"> - 批量上传相册 </span>
<div style="clear:both"></div>
</div>

<div style="padding:0 auto;margin:10px auto 0 auto;width:98%;background:#ffffff;">
	...
	<form id="form1"   action="swfupload.php" method="post" enctype="multipart/form-data">
	  <div id="divSWFUploadUI">
			...
			<p>
				...
				<input type="button" value="返回相册列表" onclick="javascript:history.go(-1)">

...
define(GAT_PINTUAN, '9');
require_once(ROOT_PATH . 'mobile/includes/lib_goods.php');
require_once(ROOT_PATH . 'mobile/includes/lib_order.php');
require_once(ROOT_PATH . 'mobile/includes/prince/lib_common.php');

require_once(ROOT_PATH . 'mobile/languages/zh_cn/admin/pintuan.php');
...
elseif ($_REQUEST['act'] == 'view') {
	...
	$smarty->assign('extpintuan_info', $pintuan_info);

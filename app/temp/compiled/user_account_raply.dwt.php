...
<div class="m-all2 bg-color-w ulev-9">
  <div class="ubb ub border-f2 ub-ac h-min1">
    <div class="f-color-6 uw-reg"> <?php echo $this->_var['lang']['repay_money']; ?>: </div>
    <div class="uinput sc-text-hui">
      <input type="text" id="amount" placeholder="请输入金额" value=""/>
    </div>
  </div>
  <div class="ubb ub border-f2 ub-ac h-min1">
    <div class="f-color-6 sc-text-hui uw-reg"> <?php echo $this->_var['lang']['process_notic']; ?>: </div>
...
<div class="m-all2 ub ub-pc bc-text-head">
  ...
  <div class="uinn-a1 user-btn1" id='reset_button' style="display:none"> <?php echo $this->_var['lang']['button_reset']; ?> </div>
</div>

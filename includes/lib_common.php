 ...
 * @return  void
 */
function log_account_change($user_id, $user_money = 0, $frozen_money = 0, $rank_points = 0, $pay_points = 0, $fh_num = 0, $credit = 0, $change_desc = '', $change_type = ACT_OTHER)
{
    /* 插入帐户变动记录 */
    $account_log = array(
        'user_id'       => $user_id,
 ...
 * @param   int     $rank_points    等级积分变动
 * @param   int     $pay_points     消费积分变动
 * @param   int     $credit2     股权分红变动
 * @param   string  $change_desc    变动说明
 * @param   int     $change_type    变动类型：参见常量文件
 * @return  void
 */
function log_account_change_new($user_id, $user_money = 0, $frozen_money = 0, $rank_points = 0, $pay_points = 0, $fh_num = 0, $credit = 0,  $credit2 = 0,$change_desc = '', $change_type = ACT_OTHER)
{
    /* 插入帐户变动记录 */
    $account_log = array(
        'user_id'       => $user_id,
...
(`ecuid`,`content`,`createtime`,`issend`,`sendtype`) 
			value ({$ecuid},'{$content}','{$createtime}','0',

...
// Settings  /includes/fckeditor/editor/plugins/swfupload/upload2012.php
	$save_path =  "../../../../../images/upload/Image/".date('Ym',time()).'/';				// The path were we will save the file (getcwd() may not be reliable and should be tested in your environment)

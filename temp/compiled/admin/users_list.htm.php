...
<div class="form-div">
	<form action="javascript:searchUser()" name="searchForm">
		...
		<input type="text" name="pay_points_gt" size="8" style="min-width: 80px;"/>
		&nbsp;<?php echo $this->_var['lang']['label_pay_points_lt']; ?>&nbsp;
		<input type="text" name="pay_points_lt" size="10" style="min-width: 80px;" />
		&nbsp;会员分红权大于&nbsp;
		<input type="text" name="fh_num_gt" size="8" style="min-width: 80px;"/>
		&nbsp;会员分红权小于&nbsp;
		<input type="text" name="fh_num_lt" size="10" style="min-width: 80px;" />
...
?>
			<tr>
				...
				<td><?php echo $this->_var['user']['fh_num']; ?></td>
				...
				<td align="center">
					...
					<a href="category.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>" title="分类VIP">
...
function searchUser()
{
    ...
    listTable.filter['fh_num_gt'] = Utils.trim(document.forms['searchForm'].elements['fh_num_gt'].value);
    listTable.filter['fh_num_lt'] = Utils.trim(document.forms['searchForm'].elements['fh_num_lt'].value);

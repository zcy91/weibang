...
<div class="form-div">
    <form action="javascript:search_category()" name="searchForm">
        ...
        <?php echo $this->_var['lang']['category_search']; ?> <input type="text" name="cat_name" size="20" />
        <input type="submit" value="<?php echo $this->_var['lang']['button_search']; ?>" class="button" />
        <input type="button" value="<?php echo $this->_var['lang']['export']; ?>" class="button" onclick="batch_export()" />
    </form>
</div>

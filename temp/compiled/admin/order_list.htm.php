...
?>
  <tr>
    <td align='center'><input type="checkbox" name="checkboxes" value="<?php echo $this->_var['order']['order_sn']; ?>" /><?php echo $this->_var['order']['order_id']; ?></td>
    ...
    <td align='center'>
	 ...
	 <?php if ($this->_var['order']['rebate_ispay'] == 1 && $this->_var['is_rebate']): ?>
	 <a href="order.php?act=rebate&order_id=<?php echo $this->_var['order']['order_id']; ?>&supp=<?php echo empty($_REQUEST['supp']) ? '0' : $_REQUEST['supp']; ?>">计算佣金</a>
	 <?php endif; ?>
    </td>
  </tr>
...
?>
  <tr class="
  	<?php if ($this->_var['order']['can_remove']): ?>tr_canceled<?php endif; ?> 
    <?php if ($this->_var['order']['pay_status'] == 0 && $this->_var['order']['order_status'] != 2): ?>tr_nopay<?php endif; ?> 
    <?php if ($this->_var['order']['shipping_status'] == 2): ?>tr_receipt<?php endif; ?>
    <?php if ($this->_var['order']['order_status'] != 2 && $this->_var['order']['pay_status'] == 2 && $this->_var['order']['shipping_status'] == 0): ?>tr_nosend<?php endif; ?>
    <?php if ($this->_var['order']['tuihuan']): ?>tr_back<?php endif; ?>">
    ...
    <td align="center" valign="top"  nowrap="nowrap">
     ...
     <br /><span style="color:#F00"><?php echo $this->_var['order']['tuihuan']['back_type']; ?>,<?php echo $this->_var['order']['tuihuan']['status_back']; ?></span>
     <?php endif; ?>
    </td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>

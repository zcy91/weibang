...
<?php echo $this->smarty_insert_scripts(array('files'=>'jquery.ztree.all-3.5.min.js')); ?>
...
<div class="tab-div"> 
  <!-- tab bar -->
  <div id="tabbar-div">
    <p> <span class="tab-front" id="general-tab"><?php echo $this->_var['lang']['tab_general']; ?></span><span
        ...
        class="tab-back" id="article-tab"><?php echo $this->_var['lang']['tab_article']; ?></span> </p>
  </div>
  ...
  <div id="tabbody-div">
      ...
      <table width="100%" id="general-table" align="center">
        <tr>
          ...
          <td><input type="text" name="goods_name" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" style="float:left;color:<?php echo $this->_var['goods_name_color']; ?>;" size="30" />
            <div style="background-color:<?php echo $this->_var['goods_name_color']; ?>;float:left;margin-left:2px;" id="font_color" onclick="ColorSelecter.Show(this);"><img src="images/color_selecter.gif" style="margin-top:-1px;" /></div>
        ...
        <tr>
          <td class="label"><a href="javascript:showNotice('noticeGoodsSN');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a> <?php echo $this->_var['lang']['lab_goods_sn']; ?> </td>
          <td><input type="text" name="goods_sn" value="<?php echo htmlspecialchars($this->_var['goods']['goods_sn']); ?>" size="20" onblur="checkGoodsSn(this.value,'<?php echo $this->_var['goods']['goods_id']; ?>')" />
	...
	<tr>
          <td class="label">商品仓位号：</td>
          <td><input type="text" name="goods_cw" value="<?php echo htmlspecialchars($this->_var['goods']['goods_cw']); ?>" size="20"  />
            </td>
        </tr>
        <tr>
          <td class="label"><?php echo $this->_var['lang']['lab_goods_cat']; ?></td>
          <td><input type="text" id="cat_name" name="cat_name" 

nowvalue="<?php echo $this->_var['goods_cat_name']; ?>" value="<?php echo $this->_var['goods_cat_name']; ?>" >
            <input type="hidden" id="cat_id" name="cat_id" value="<?php echo $this->_var['goods_cat_id']; ?>">
            <div id="menuContent" class="menuContent" style="display: none; position: 

absolute; background-color: white; border: 1px black solid;">
              <div style="text-align: center;">
                <input type="button" id="btn_expand_all" 

value="<?php echo $this->_var['lang']['cat_expand_all']; ?>" class="button expand_all">
                <input type="button" id="btn_expand" value="<?php echo $this->_var['lang']['cat_expand']; ?>" 

class="button expand">
                <input type="button" id="btn_collect" 

value="<?php echo $this->_var['lang']['cat_collect']; ?>" class="button collect">
              </div>
              <ul id="treeDemo" class="ztree" style="margin-top:0; width:250px; 

height: 300px; overflow: auto;">
              </ul>
            </div>
            <?php if ($this->_var['is_add']): ?> <a href="javascript:void(0)" onclick="rapidCatAdd()" title="<?php echo $this->_var['lang']['rapid_add_cat']; ?>" class="special"><?php echo $this->_var['lang']['rapid_add_cat']; ?></a> <span id="category_add" style="display:none;">
            <input class="text" size="10" name="addedCategoryName" />
            <a href="javascript:void(0)" onclick="addCategory()" title="<?php echo $this->_var['lang']['button_submit']; ?>" class="special" ><?php echo $this->_var['lang']['button_submit']; ?></a> <a href="javascript:void(0)" onclick="return goCatPage()" title="<?php echo $this->_var['lang']['category_manage']; ?>" class="special" ><?php echo $this->_var['lang']['category_manage']; ?></a> <a href="javascript:void(0)" onclick="hideCatDiv()" title="<?php echo $this->_var['lang']['hide']; ?>" class="special" ><<</a> </span> <?php endif; ?>
            ...
            <script type="text/javascript">
				...
				function getFont(treeId, node) {
           		...
           		function onClick(e, treeId, treeNode) 
           		{
           			...
           			$("#cat_id").attr("value", nodes[0].id);
           			$("#cat_name").attr("value", nodes[0].name);
           			$("#cat_name").attr("nowvalue", nodes[0].name);
           		}

           		function showMenu()
           		{
           			var catObj = $("#cat_name");
           			var offset = $("#cat_name").offset();
           			$("#menuContent").css({left: offset.left + "px", top: 

offset.top + catObj.outerHeight() + "px"}).slideDown("fast");
...
$("#cat_id").val()), true);
           		...
           		{
           			if (!(event.target.id == "menuBtn" || event.target.id == 

"menuContent" || $(event.target).parents("#menuContent").length>0)) {
           				hideMenu();
           			}
           		}

	           	var zNodes = <?php echo $this->_var['goods_cat_list']; ?>;
	           	...
	           	function getRelationNodes(nodes, id)
	           	{
	           		...
	           		if(node != null && node.pId != 0 && hashSet[node.pId] == 
...
undefined){
	           	...
	           	function search(keyword)
	           	{
		           	...
		           	{
		           		var node = zNodes[i];
		           		if(node != null && node.name_pinyin.indexOf(keyword) 

!= -1 && hashSet[node.pId] == undefined)
		           		{
		           			node.font = {'color': 'red'};
		           			nodes.push(node);
		           			hashSet[node.id] = 0;
	    		...
	    		$().ready(function(){
		    		...
		    		var selectNode = zTree.getNodeByParam("id", 

"<?php echo $this->_var['goods_cat_id']; ?>");
		    		if(selectNode != null)
		    		{
		    		...
		    		$("#btn_expand_all").click(function(){
		    			...
		    			if(expand)
		    			{
		    				$(this).val("<?php echo $this->_var['lang']['cat_expand_all']; ?>");
		    			}
		    			else
		    			{
		    				$(this).val("<?php echo $this->_var['lang']['cat_collect_all']; ?>");
		    			}
        ...
        <tr>
          ...
          <td><input type="button" value="<?php echo $this->_var['lang']['add']; ?>" onclick="addOtherCat(this.parentNode)" class="button" />
...
?>
            ...
            <select name="other_cat[]" onchange="hideCatDiv()" ><option value="0"><?php echo $this->_var['lang']['select_please']; ?>

</option><?php echo $this->_var['cat_other_list']; ?></select>
            </td>
        </tr>
        <tr>
          <td class="label"><?php echo $this->_var['lang']['lab_goods_brand']; ?></td>
          <td><!-- 代码修改_start_derek20150129admin_goods  www.68ecshop.com -->
            ...
            <?php if ($this->_var['is_add']): ?> <a href="javascript:void(0)" title="<?php echo $this->_var['lang']['rapid_add_brand']; ?>" onclick="rapidBrandAdd()" class="special" ><?php echo $this->_var['lang']['rapid_add_brand']; ?></a> <span id="brand_add" style="display:none;">
            <input class="text" size="15" name="addedBrandName" />
            <a href="javascript:void(0)" onclick="addBrand()" class="special" ><?php echo $this->_var['lang']['button_submit']; ?></a> <a href="javascript:void(0)" onclick="return goBrandPage()" title="<?php echo $this->_var['lang']['brand_manage']; ?>" class="special" ><?php echo $this->_var['lang']['brand_manage']; ?></a> <a href="javascript:void(0)" onclick="hideBrandDiv()" title="<?php echo $this->_var['lang']['hide']; ?>" class="special" ><<</a> </span> <?php endif; ?> 
            ...
            <div id="brand_content" style="margin-top:5px; margin-bottom:10px; display:none">
              <div style="float:left; overflow-y:scroll; width:420px; height:120px; border:#CCC 1px solid">
                ...
                <table width="400" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td valign="top" style="padding-left:10px"><!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_80060200_1553139930');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80060200_1553139930']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list_0_80060200_1553139930']['name_p'] >= "a" && $this->_var['brand_list_0_80060200_1553139930']['name_p'] <= "g"): ?> -->
                      
                      <div id="@<?php echo $this->_var['key']; ?>">
                        <div id="<?php echo $this->_var['brand_list_0_80060200_1553139930']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_80060200_1553139930']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_80060200_1553139930']['name']; ?>')"><?php echo $this->_var['brand_list_0_80060200_1553139930']['name']; ?></a></div>
                      </div>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80060200_1553139930']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list_0_80060200_1553139930']['name_p'] >= "h" && $this->_var['brand_list_0_80060200_1553139930']['name_p'] <= "k"): ?> -->
                      ...
                      <!-- <?php endif; ?> --> 
                      <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> --></td>
                    <td valign="top" style="padding-left:10px"><!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_80160200_1553139930');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80160200_1553139930']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list_0_80160200_1553139930']['name_p'] >= "l" && $this->_var['brand_list_0_80160200_1553139930']['name_p'] <= "s"): ?> -->
                      
                      <div id="@<?php echo $this->_var['key']; ?>">
                        <div id="<?php echo $this->_var['brand_list_0_80160200_1553139930']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_80160200_1553139930']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_80160200_1553139930']['name']; ?>')"><?php echo $this->_var['brand_list_0_80160200_1553139930']['name']; ?></a></div>
                      </div>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80160200_1553139930']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list_0_80160200_1553139930']['name_p'] >= "t" && $this->_var['brand_list_0_80160200_1553139930']['name_p'] <= "z"): ?> -->
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_80160200_1553139930']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list_0_80160200_1553139930']['name_p'] >= "0" && $this->_var['brand_list_0_80160200_1553139930']['name_p'] <= "9"): ?> -->
            ...
            <!-- 代码增加_end_derek20150129admin_goods  www.68ecshop.com --></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="shop_price" value="<?php echo $this->_var['goods']['shop_price']; ?>" size="20" onblur="priceSetted()" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
            <input type="button" value="<?php echo $this->_var['lang']['compute_by_mp']; ?>" onclick="marketPriceSetted()" />
            <?php echo $this->_var['lang']['require_field']; ?></td>
        </tr>
          <tr>
              <td class="label">虚拟销量：</td>
              <td><input type="text" name="goods_sales" value="<?php echo htmlspecialchars($this->_var['goods']['goods_sales']); ?>" size="20"  />
              </td>
          </tr>
...
?>
            <?php echo $this->_var['user_rank']['rank_name']; ?><span id="nrank_<?php echo $this->_var['user_rank']['rank_id']; ?>"></span>
            ...
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="noticeUserPrice"><?php echo $this->_var['lang']['notice_user_price']; ?></span></td>
        </tr>
        <?php endif; ?> 
        ...
        <tr>
          ...
          <td><table width="100%" id="tbody-volume" align="center">
...
?>
              <tr>
                <td> <?php if ($this->_foreach['volume_price_tab']['iteration'] == 1): ?> <a href="javascript:;" onclick="addVolumePrice(this)">[+]</a> <?php else: ?> <a href="javascript:;" onclick="removeVolumePrice(this)">[-]</a> <?php endif; ?>
                  <?php echo $this->_var['lang']['volume_number']; ?>
                  ...
                  <input type="text" name="volume_price[]" size="8" value="<?php echo $this->_var['volume_price']['price']; ?>"/></td>
              </tr>
              <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </table>
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="volumePrice"><?php echo $this->_var['lang']['notice_volume_price']; ?></span></td>
        </tr>
        <!--鍟嗗搧浼樻儬浠锋牸 end -->
        
        <tr>
          <td class="label"><?php echo $this->_var['lang']['lab_market_price']; ?></td>
          <td><input type="text" name="market_price" value="<?php echo $this->_var['goods']['market_price']; ?>" size="20" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
            <input type="button" value="<?php echo $this->_var['lang']['integral_market_price']; ?>" onclick="integral_market_price()" /></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="give_integral" value="<?php echo $this->_var['goods']['give_integral']; ?>" size="20" />
            <br />
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="giveIntegral"><?php echo $this->_var['lang']['notice_give_integral']; ?></span></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="rank_integral" value="<?php echo $this->_var['goods']['rank_integral']; ?>" size="20" />
            <br />
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="rankIntegral"><?php echo $this->_var['lang']['notice_rank_integral']; ?></span></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="integral" value="<?php echo $this->_var['goods']['integral']; ?>" size="20" onblur="parseint_integral()"; onkeyup="value=value.replace(/[^\d]/g,'')"/>
            <br />
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="noticPoints"><?php echo $this->_var['lang']['notice_integral']; ?></span></td>
        </tr>
        <tr>
          <td class="label"><label for="is_promote">
              ...
              <?php echo $this->_var['lang']['lab_promote_price']; ?></label></td>
          <td id="promote_3"><input type="text" id="promote_1" name="promote_price" value="<?php echo $this->_var['goods']['promote_price']; ?>" size="20" 　onkeyup="value=value.replace(/[^\d.]/g,'')"/></td>
        </tr>
        <tr id="promote_4">
          <td class="label" id="promote_5"><?php echo $this->_var['lang']['lab_promote_date']; ?></td>
          <td id="promote_6"><input name="promote_start_date" type="text" id="promote_start_date" size="12" value='<?php echo $this->_var['goods']['promote_start_date']; ?>' readonly="readonly" />
            ...
            <input name="selbtn2" type="button" id="selbtn2" onclick="return showCalendar('promote_end_date', '%Y-%m-%d', false, false, 'selbtn2');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/></td>
        </tr>
        <tr>
          <td class="label"><?php echo $this->_var['lang']['lab_picture']; ?></td>
          <td><input type="file" name="goods_img" size="35" />
            <?php if ($this->_var['goods']['goods_img']): ?> <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_img']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a> <?php else: ?> <img src="images/no.gif" /> <?php endif; ?> <br />
            <input type="text" size="40" value="<?php echo $this->_var['lang']['lab_picture_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['lab_picture_url']; ?>'){this.value='http://';this.style.color='#000';}" name="goods_img_url"/></td>
        </tr>
        <tr id="auto_thumb_1">
          <td class="label"> <?php echo $this->_var['lang']['lab_thumb']; ?></td>
          <td id="auto_thumb_3"><input type="file" name="goods_thumb" size="35" />
            <?php if ($this->_var['goods']['goods_thumb']): ?> <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_thumb']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a> <?php else: ?> <img src="images/no.gif" /> <?php endif; ?> <br />
            ...
            <label for="auto_thumb">
              ...
              <?php echo $this->_var['lang']['auto_thumb']; ?></label>
            <?php endif; ?> </td>
        </tr>
        <!--代码增加_start byjdy-->
        <tr>
          <td class="label" ><font color=#ff3300>是否显示在频道首页：</font></td>
          <td ><input type="checkbox" name="is_catindex" value="1" <?php if ($this->_var['goods']['is_catindex']): ?>checked="checked"<?php endif; ?> />
            打勾表示在频道首页显示，否则不显示。</td>
        </tr>
        <!--代码增加_end byjdy--> 
        ...
        <tr>
          ...
          <td><input type="radio" name="supplier_status" value="1" <?php if ($this->_var['goods']['supplier_status'] == '1'): ?>checked=checked<?php endif; ?>>
            审核通过
      ...
      <table width="90%" id="mix-table" style="display:none" align="center">
        ...
        <tr>
          ...
          <td><input type="text" name="goods_weight" value="<?php echo $this->_var['goods']['goods_weight_by_unit']; ?>" size="20" />
            <select name="weight_unit">
              <?php echo $this->html_options(array('options'=>$this->_var['unit_list'],'selected'=>$this->_var['weight_unit'])); ?>
            </select></td>
        </tr>
        <?php endif; ?>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="is_best" value="1" <?php if ($this->_var['goods']['is_best']): ?>checked="checked"<?php endif; ?> />
            ...
            <?php echo $this->_var['lang']['is_hot']; ?></td>
        </tr>
        <tr id="alone_sale_1">
          <td class="label" id="alone_sale_2"><?php echo $this->_var['lang']['lab_is_on_sale']; ?></td>
          <td id="alone_sale_3"><input type="checkbox" name="is_on_sale" value="1" <?php if ($this->_var['goods']['is_on_sale']): ?>checked="checked"<?php endif; ?> />
            <?php echo $this->_var['lang']['on_sale_desc']; ?></td>
        </tr>
        <tr>
          <td class="label"><?php echo $this->_var['lang']['lab_is_alone_sale']; ?></td>
          <td><input type="checkbox" name="is_alone_sale" value="1" <?php if ($this->_var['goods']['is_alone_sale']): ?>checked="checked"<?php endif; ?> />
            <?php echo $this->_var['lang']['alone_sale']; ?></td>
        </tr>
        <tr>
          <td class="label"><?php echo $this->_var['lang']['lab_is_free_shipping']; ?></td>
          <td><input type="checkbox" name="is_shipping" value="1" <?php if ($this->_var['goods']['is_shipping']): ?>checked="checked"<?php endif; ?> />
            <?php echo $this->_var['lang']['free_shipping']; ?></td>
        </tr>
        <tr>
          <td class="label"><?php echo $this->_var['lang']['lab_keywords']; ?></td>
          <td><input type="text" name="keywords" value="<?php echo htmlspecialchars($this->_var['goods']['keywords']); ?>" size="40" />
            <?php echo $this->_var['lang']['notice_keywords']; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="label"><a href="javascript:showNotice('noticeSellerNote');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a> <?php echo $this->_var['lang']['lab_seller_note']; ?> </td>
		...
		<tr>
            <td class="label">分销商代理佣金：</td>
            <td><input type="text" name="user_rebate_price" value="<?php echo $this->_var['goods']['user_rebate_price']; ?>" size="20" />
              <input type="button" value="<?php echo $this->_var['lang']['integral_market_price']; ?>" onclick="integral_user_rebate_price()" />
			  <span class="notice-span">佣金指分销商支付给入驻商家的佣金</span>
            </td>
          </tr>
      </table>
      ...
      <table width="100%" id="properties-table" style="display:none" align="center">
        <tr>
          ...
          <td><select name="goods_type" onchange="getAttrList(<?php echo $this->_var['goods']['goods_id']; ?>)">
      ...
      <table width="100%" id="gallery-table" style="display:none" align="center">
        ...
        <tr>
          <td><style>
            ...
            <font color=#ff3300>请选择商品颜色</font>（点击下面不同颜色切换到该颜色对应的相册）<br>
            <br>
            <div class="attr-color-div"> <?php $_from = $this->_var['color_list_www_ecshop68_com']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'color_qq');$this->_foreach['color_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['color_list']['total'] > 0):
    foreach ($_from AS $this->_var['color_qq']):
        $this->_foreach['color_list']['iteration']++;
?> <span class="<?php if ($this->_foreach['color_list']['iteration'] == 1): ?>attr-front<?php else: ?>attr-back<?php endif; ?>" id="color_<?php echo $this->_foreach['color_list']['iteration']; ?>"> <a href="attr_img_upload.php?goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&goods_attr_id=<?php echo $this->_var['color_qq']['goods_attr_id']; ?>" onclick="javascript:changeCurrentColor(<?php echo $this->_foreach['color_list']['iteration']; ?>)" target="attr_upload"><?php echo $this->_var['color_qq']['attr_value']; ?></a> </span> <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> </div>
            <iframe  name="attr_upload" src="attr_img_upload.php?goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&goods_attr_id=<?php echo $this->_var['color_list_www_ecshop68_com']['0']['goods_attr_id']; ?>" frameborder=1 scrolling=no width="100%" height="auto" style="min-height:630px; border:1px #eee solid; margin-top:5px;"> </iframe></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
      ...
      <table width="90%" id="linkgoods-table" style="display:none" align="center">
        ...
        <tr>
          <td colspan="3"><img src="images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
            ...
            <input type="button" value="<?php echo $this->_var['lang']['button_search']; ?>"  class="button"
                onclick="searchGoods(sz1, 'cat_id1','brand_id1','keyword1')" /></td>
        </tr>
        <!-- 鍟嗗搧鍒楄〃 -->
        <tr>
        ...
        <tr>
          <td width="42%"><select name="source_select1" size="20" style="width:100%" ondblclick="sz1.addItem(false, 'add_link_goods', goodsId, this.form.elements['is_single'][0].checked)" multiple="true">
            </select></td>
          <td align="center"><p>
              <input name="is_single" type="radio" value="1" checked="checked" />
              <?php echo $this->_var['lang']['single']; ?><br />
              <input name="is_single" type="radio" value="0" />
              <?php echo $this->_var['lang']['double']; ?></p>
            <p>
          ...
          <td width="42%"><select name="target_select1" size="20" style="width:100%" multiple ondblclick="sz1.dropItem(false, 'drop_link_goods', goodsId, elements['is_single'][0].checked)">
      ...
      <table width="90%" id="groupgoods-table" style="display:none" align="center">
        ...
        <tr>
          <td colspan="3"><img src="images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
            ...
            <input type="button" value="<?php echo $this->_var['lang']['button_search']; ?>" onclick="searchGoods(sz2, 'cat_id2', 'brand_id2', 'keyword2')" class="button" /></td>
        </tr>
        <!-- 鍟嗗搧鍒楄〃 -->
        <tr>
          <th><?php echo $this->_var['lang']['all_goods']; ?></th>
        ...
        <tr>
          <td width="42%"><select name="source_select2" size="20" style="width:100%" onchange="sz2.priceObj.value = this.options[this.selectedIndex].id" ondblclick="sz2.addItem(false, 'add_group_goods', goodsId, this.form.elements['price2'].value)">
            </select></td>
          <td align="center"><p><?php echo $this->_var['lang']['price']; ?><br />
          ...
          <td width="42%"><select name="target_select2" size="20" style="width:100%" multiple ondblclick="sz2.dropItem(false, 'drop_group_goods', goodsId, elements['is_single'][0].checked)">
...
?>
      ...
      <table width="90%" id="article-table" style="display:none" align="center">
        <!-- 鏂囩珷鎼滅储 -->
        <tr>
          <td colspan="3"><img src="images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" /> <?php echo $this->_var['lang']['article_title']; ?>
            <input type="text" name="article_title" />
            <input type="button" value="<?php echo $this->_var['lang']['button_search']; ?>" onclick="searchArticle()" class="button" /></td>
        </tr>
        <!-- 鏂囩珷鍒楄〃 -->
        <tr>
        ...
        <tr>
          <td width="45%"><select name="source_select3" size="20" style="width:100%" multiple ondblclick="sz3.addItem(false, 'add_goods_article', goodsId, this.form.elements['price2'].value)">
            </select></td>
          <td align="center"><p>
          ...
          <td width="45%"><select name="target_select3" size="20" style="width:100%" multiple ondblclick="sz3.dropItem(false, 'drop_goods_article', goodsId, elements['is_single'][0].checked)">
...
?>
  ...
  function integral_market_price()
  {
   ...
   function integral_user_rebate_price()
  {
    document.forms['theForm'].elements['user_rebate_price'].value = parseInt(document.forms['theForm'].elements['user_rebate_price'].value);
  }

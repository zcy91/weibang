<!-- $Id: virtual_goods_list.htm 17126 2010-04-23 10:30:26Z liuhui $ -->
...
<!-- 商品搜索 -->
<?php echo $this->fetch('virtual_goods_search.htm'); ?>
<!-- 商品列表 -->
...
?>
  <tr>
    ...
    <?php endif; ?>
        ...
        <td align="right">
            <?php if ($this->_var['goods']['supplier_status'] == 0): ?> 未审核<?php endif; ?>
            <?php if ($this->_var['goods']['supplier_status'] == 1): ?> 已通过<?php endif; ?>
            <?php if ($this->_var['goods']['supplier_status'] == 2): ?> 未通过<?php endif; ?>
        </td>
        <td align="right">
            <?php echo $this->_var['goods']['district']; ?>
        </td>
    ...
    <td align="center">
      ...
      <a href="virtual_goods.php?act=edit&goods_id=<?php echo $this->_var['goods']['goods_id']; ?><?php if ($this->_var['code'] != 'real_goods'): ?>&supplier_status=<?php echo $_REQUEST['supplier_status']; ?>&extension_code=<?php echo $this->_var['code']; ?><?php endif; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="virtual_goods.php?act=copy&goods_id=<?php echo $this->_var['goods']['goods_id']; ?><?php if ($this->_var['code'] != 'real_goods'): ?>&extension_code=<?php echo $this->_var['code']; ?><?php endif; ?>" title="<?php echo $this->_var['lang']['copy']; ?>"><img src="images/icon_copy.gif" width="16" height="16" border="0" /></a>
      ...
      <?php if ($this->_var['specifications'] [ $this->_var['goods']['goods_type'] ] != ''): ?><a href="virtual_goods.php?act=product_list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&supplier_status=<?php echo $_REQUEST['supplier_status']; ?>" title="<?php echo $this->_var['lang']['item_list']; ?>"><img src="images/icon_docs.gif" width="16" height="16" border="0" /></a><?php else: ?><img src="images/empty.gif" width="16" height="16" border="0" /><?php endif; ?>

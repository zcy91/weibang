      <tr>
        <td class="label" valign="top">
          ...
          <?php endif; ?>
		  <?php if ($this->_var['var']['name'] != "jingdu" && $this->_var['var']['name'] != "weidu"): ?>
...
?>
	...
	<!-- <div style="width:850px;margin:auto;">   
        请输入要查询的地址（如秦皇岛）：<input id="text_" type="text" value="秦皇岛" style="min-width:150px;"/>
		...
		经度：<input name="jingdu" type="text" value="" id="jingdu"  style="min-width:90px;"/>
		纬度：<input name="weidu" type="text" value="" id="weidu" style="min-width:90px;" /> -->

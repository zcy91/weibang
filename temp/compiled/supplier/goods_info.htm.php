            ...
            <table width="400" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_41077000_1457590252');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_41077000_1457590252']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_41077000_1457590252']['name_p'] >= "a" && $this->_var['brand_list_0_41077000_1457590252']['name_p'] <= "g"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_41077000_1457590252']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_41077000_1457590252']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_41077000_1457590252']['name']; ?>')"><?php echo $this->_var['brand_list_0_41077000_1457590252']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px"> 
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_41104900_1457590252');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_41104900_1457590252']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_41104900_1457590252']['name_p'] >= "h" && $this->_var['brand_list_0_41104900_1457590252']['name_p'] <= "k"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_41104900_1457590252']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_41104900_1457590252']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_41104900_1457590252']['name']; ?>')"><?php echo $this->_var['brand_list_0_41104900_1457590252']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_41156300_1457590252');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_41156300_1457590252']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_41156300_1457590252']['name_p'] >= "l" && $this->_var['brand_list_0_41156300_1457590252']['name_p'] <= "s"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_41156300_1457590252']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_41156300_1457590252']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_41156300_1457590252']['name']; ?>')"><?php echo $this->_var['brand_list_0_41156300_1457590252']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_41205500_1457590252');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_41205500_1457590252']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_41205500_1457590252']['name_p'] >= "t" && $this->_var['brand_list_0_41205500_1457590252']['name_p'] <= "z"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_41205500_1457590252']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_41205500_1457590252']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_41205500_1457590252']['name']; ?>')"><?php echo $this->_var['brand_list_0_41205500_1457590252']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_41251400_1457590252');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_41251400_1457590252']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_41251400_1457590252']['name_p'] >= "0" && $this->_var['brand_list_0_41251400_1457590252']['name_p'] <= "9"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_41251400_1457590252']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_41251400_1457590252']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_41251400_1457590252']['name']; ?>')"><?php echo $this->_var['brand_list_0_41251400_1457590252']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                </tr>

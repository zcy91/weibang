	  ...
	  <tr>
		...
		<input type="file" name="cat_pic" size="35" />
              <?php if ($this->_var['cat_info']['cat_pic']): ?>
                ...
                <a href="category.php?act=delete_image&img_id=<?php echo $this->_var['cat_info']['cat_id']; ?>&img_url=<?php echo $this->_var['cat_info']['cat_pic']; ?>" target="_self"><img src="images/no.gif" border="0" /></a>
              <?php else: ?>

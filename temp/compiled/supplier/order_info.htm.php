...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td><?php echo $this->_var['order']['froms']; ?></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo htmlspecialchars($this->_var['order']['best_time']); ?></td>
  </tr>
</table>
</div>
...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th colspan="10" scope="col"><?php echo $this->_var['lang']['goods_info']; ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=goods" class="special"><?php echo $this->_var['lang']['edit']; ?></a></th>
    </tr>
  <tr>
...
?>
	...
	<td><div align="right"><?php echo $this->_var['goods']['exclusive']; ?></div></td><!--手机专享价格 app jx -->
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <input name="invoice_no" type="text" style="color:#00F" value="请输入快递单号" />

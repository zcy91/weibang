...
<table width="100%">
  <tr>
    ...
    <td>
      <input type='text' name='type_name' maxlength="30" value="<?php echo $this->_var['bonus_arr']['type_name']; ?>" size='20' /><span class="require-field">*</span>    </td>
  </tr>
  <tr>
    <td class="label">
    ...
    <td>
    <input type="text" name="type_money" value="<?php echo $this->_var['bonus_arr']['type_money']; ?>" size="20" /><span class="require-field">*</span>
  ...
  <tr id="1" style="display:none">
    ...
    <td>
      <input name="min_amount" type="text" id="min_amount" value="<?php echo $this->_var['bonus_arr']['min_amount']; ?>" size="20" /><span class="require-field">*</span>

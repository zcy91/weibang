...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <!--  <input onclick='listTable.selectAll(this, "checkboxes")' type="checkbox">-->
      <a href="javascript:listTable.sort('order_sn','DESC'); ">订单号</a> <?php echo $this->_var['sort_order_sn']; ?></th>
...
?>
  <tr>
    ...
    <?php else: ?>
        ...
        <img src="images/<?php if ($this->_var['comment']['is_comment']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="javascript:alert('平台方已关闭该权限')" />

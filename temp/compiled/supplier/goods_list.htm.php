...
<table cellpadding="3" cellspacing="1">
  <tr>
	...
	<th><a href="javascript:listTable.sort('exclusive'); ">手机专享价</a><?php echo $this->_var['sort_shop_price']; ?></th><!--手机专享价格   app  jx-->
    ...
    <th><a href="javascript:listTable.sort('is_best'); ">店内<?php echo $this->_var['lang']['is_best']; ?></a><?php echo $this->_var['sort_is_best']; ?></th>
    <th><a href="javascript:listTable.sort('is_new'); ">店内<?php echo $this->_var['lang']['is_new']; ?></a><?php echo $this->_var['sort_is_new']; ?></th>
    <th><a href="javascript:listTable.sort('is_hot'); ">店内<?php echo $this->_var['lang']['is_hot']; ?></a><?php echo $this->_var['sort_is_hot']; ?></th>
    <?php endif; ?>
...
?>
  <tr>
    ...
    <td class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><span <?php if ($this->_var['is_editgoods']): ?>onclick="listTable.edit(this, 'edit_goods_name', <?php echo $this->_var['goods']['goods_id']; ?>)"<?php endif; ?>><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></span></td>
    <td><span <?php if ($this->_var['is_editgoods']): ?>onclick="listTable.edit(this, 'edit_goods_sn', <?php echo $this->_var['goods']['goods_id']; ?>)"<?php endif; ?>><?php echo $this->_var['goods']['goods_sn']; ?></span></td>
    <td align="right"><span <?php if ($this->_var['is_editgoods']): ?>onclick="listTable.edit(this, 'edit_goods_price', <?php echo $this->_var['goods']['goods_id']; ?>)"<?php endif; ?>><?php echo $this->_var['goods']['shop_price']; ?>

    </span></td>
	<!-- 手机专享价格   app  jx  开始-->
	<td align="right"><span onclick="listTable.edit(this, 'edit_exclusive', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['exclusive']; ?>
    ...
    <?php endif; ?>
    <?php if ($this->_var['use_storage']): ?>
    <td align="right"><span <?php if ($this->_var['is_editgoods']): ?>onclick="listTable.edit(this, 'edit_goods_number', <?php echo $this->_var['goods']['goods_id']; ?>)"<?php endif; ?>><?php echo $this->_var['goods']['goods_number']; ?></span></td>
    <?php endif; ?>
    <td align="center"><a href="goods_tag.php?act=list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" >标签</a></td> <!-- 晒单插件 增加 by www.68ecshop.com -->
    <td align="center">

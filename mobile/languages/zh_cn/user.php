...
$_LANG['affiliate_intro'][0] = '　　         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span ">〖微帮众筹平台〗</span>
    招募合伙人……
    1.平台进货累计5000积分。即可成为我们的合伙人。

    2.共享平台60&#37的利润分红。天天有钱分 进货=投资

    3.花本该花的钱~进本该进的货~分本该分不到的钱。　
<b style="display:none">注明： 每日营业额分红数量不固定，收入由系统自动结算 <a href="#myrecommend">我推荐的会员</a></b>
　<span>〔减少一切中间环节〕</span>
<span>分红规则：</span>《平台总销量低于5000积分停止分红》
      
      分红规则：
【总销量低于5000积分停止分红】
 如：平台销量为10万积分， 总利润为20000元，减去6&#37运营成本， 剩下60&#37每日分红。 如：分红利润为10000元、总分红权数量为1000个，每个分红权收入为10元，如您持有10个分红权，收入为100元每天……

如何增加分红权？
     1. 进货累计5000积分自动增加1个分权。
     2.充值赠送
     3.推荐会员
     4.分红权100个封顶
...
运营成本核算：
      ...
      <span>义乌市星奇巴电子商务有限公司</span>
       ';
$_LANG['affiliate_intro'][3] = '　
      股权认购说明：
【总股数1000股』每股1200元】
 持股期限：
 〖可选择半年、一年、5年〗
  1.持股半年、每日到账投资本金的 0.6&#37
     加每日利润分红。

  2.持股一年、每日到账投资本金的0.3&#37
     加每日利润分红。

  3.持股期限五年、每日到账投资本金的0.1&#37 加每日分红收益。

  4.投资金额最低1200元，最高限购24000元。

  5.没盈利返本金，如：持股半年1万元，
      每天到账60元加每日利润分红。

 6.提现2元起，扣除1&#37手续费秒到微信钱包。
       ';
$_LANG['affiliate_intro'][4] = '　
      微帮vip会员购买协议：
 购买微帮平台半年ｖｉｐ服务，为3000元（赠送公司0.1&#37股份半年分红）
 购买微帮一年vip服务，为5000元（赠送公司0.1&#37股份一年分红）分红为每天一次、（最低3元每天-上不封顶）提现系统扣除1&#37的手续费、提现秒到微信钱包。
 服务内容：
    1.vip会员可共享平台，供应链资源。
    2.vip会员所有商品以平台采购入库价供应。
    3.vip会员可自由选择微帮商城的所有商品。
    4.vip会员可选择一个指定的配送地址。
    5.vip会员下单平台负责48小时内免费配送。
    6.vip半年会员享有50次免费配送服务。
    7.vip年会员享有100次免费配送服务。
    8.vip会员股权赠送仅限金华地区前100名。
    9.平台只提供正品服务（拒绝假货）。
    10.商品质量问题由平台负责调换。
    11.为建立双方互惠共赢长久合作原则、其他细节可电话协商。15825763987金华地区运营中心
 最终解释权归“义乌市星奇巴电子商务有限公司”
       ';
...
　<span>４</span>、您将获得该订单金额的 <b>%s</b> 、积分的 >的奖励。

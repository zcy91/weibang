...
{
    $sql = "SELECT rec_id, goods_id, goods_name,goods_cw,cwnum, goods_sn, market_price, goods_number, " .
...
$sql_where = $_SESSION['user_id']>0 ? "c.user_id='". $_SESSION['user_id'] ."' " : "c.session_id = '" . SESS_ID . "' AND c.user_id=0 ";
    $sql = "SELECT c.rec_id, c.user_id, c.goods_id, c.goods_name, c.goods_cw,c.cwnum,c.goods_sn, c.goods_number, c.market_price, " .
...
function addto_cart($goods_id, $num = 1, $spec = array(), $parent = 0)
{
    ...
    /* 取得商品信息 */
    $sql = "SELECT g.goods_name, g.goods_cw,g.cwnum,g.goods_sn, g.is_on_sale, g.is_real, ".
